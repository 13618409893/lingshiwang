<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:106:"E:\wamp\bin\apache\apache2.4.9\htdocs\lingshi\public/../application/admin\view\goods\product_category.html";i:1525492109;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
	...
	callback: {
		beforeClick: function(treeId, treeNode) {
				...
				$.ajax({
	             ...
	             success:function(data){
	           		if(data==1){
	           			alert("删除成功"); parent.location.href="<?php echo url('product_category'); ?>";
	           		}else{
	           			alert(data);parent.location.href="<?php echo url('product_category'); ?>";
	           		}
	             }
	            })
		}
